...
public void main(HttpMessage httpMessage){
    ...
    try{
        ...
        ProcessBuilder pb2 = new ProcessBuilder("/home/pcroot/dotnet/dotnet","/home/pcroot/Desktop/MinifyApp/Minify.ConsoleApp/bin/Debug/netcoreapp2.1/Minify.ConsoleApp.dll","-u",httpMessage.getUrl(),"-f",fileName,"-css","-js","-mcss","-mjs");
