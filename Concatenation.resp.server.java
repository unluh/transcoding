...
public void main(HttpMessage httpMessage){
    ...
    try{
        ...
        ProcessBuilder pb2 = new ProcessBuilder("/home/pcroot/dotnet/dotnet","/home/pcroot/Desktop/ProxyApp/Proxy.ConsoleApp/bin/Debug/netcoreapp2.1/Proxy.ConsoleApp.dll","-u",httpMessage.getUrl(),"-f",fileName,"-css","-js");
